...
const themes = {
  ...
  ".cm-atom,  .cm-number,  .cm-keyword,  .cm-variable,  .cm-attribute,  .cm-quote,  .cm-hr,  .cm-link": {
    "color": "#fc9"
  },
  ".cm-property": {
    "color": "#9a86fd"
  },
  ".cm-punctuation,  .cm-unit,  .cm-negative": {
    "color": "#e09142"
  },
  ".cm-string": {
    "color": "#ffb870"
  ...
  ".cm-variable-2,  .cm-variable-3,  .cm-type,  .cm-string-2,  .cm-url": {
    "color": "#7a63ee"
  },
  ".cm-def,  .cm-tag,  .cm-builtin,  .cm-qualifier,  .cm-header,  .cm-em": {
    "color": "#eeebff"
  },
  ".cm-bracket,  .cm-comment": {
    "color": "#a7a5b2"
  },
  ...
  "div.cm-simplescroll-horizontal div:hover,  div.cm-simplescroll-vertical div:hover": {
    "backgroundColor": "rgb(80 80 80 / 70%)"
  },
  "div.cm-simplescroll-horizontal div,  div.cm-simplescroll-vertical div": {
  ...
  "div.cm-overlayscroll-horizontal div, div.cm-overlayscroll-vertical div": {
